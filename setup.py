"""
atender is a simple, lightweight, library for creating background jobs, and
processing them.
"""
import os
...
setup(
    name='atender',
    version=get_version(),
    url='https://github.com/secretum-inc/atender/',
    license='MIT',
    author='Gerrishon Sirere',
    author_email='secretum.inc@pm.me',
    description='atender is a simple, lightweight, library for creating background '
